...
class CurrentsController < ApplicationController
  before_action :set_current, only: %i[show edit update destroy]
  ...
  def destroy
    @current.destroy
    respond_to do |format|
      format.html { redirect_to new_order_url, notice: 'Current was successfully destroyed.' }
